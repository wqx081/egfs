...
handle_write(FileID, ChunkID, _Begin, Size, {Listen, IP, Port}, []) ->
    case check_boundary(ChunkID, _Begin, Size) of
	true ->
...
write_process(Listen, FileID, ChunkID, Begin, Size) ->
    ...
    loop_receive(SocketData, Hdl, Begin, Size, 0),
    file:close(Hdl),
...
wait_for_another(Socket, Hdl) ->
    receive
	{tcp, Socket, {writechunk, FileID, ChunkID, Begin, Size, _Nodelist}} ->
